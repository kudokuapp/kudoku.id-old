...
export const Tooltip = (props: {
    ...
    return (
        <div
            className="h-fit relative flex items-center z-[5]"
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
        >
            <div
                className="absolute whitespace-no-wrap bg-onBackground/75 text-onPrimary text-xs px-1.5 py-2 rounded-lg flex items-center transition-all duration-150"
